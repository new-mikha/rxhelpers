...
/**
 * This is pretty much a copy (with minor changes) of the original RX's ReplaySubjectConcurrencyTest.
 * For tests specific to the concurency of {@link ReplayRemoveSubject}, see {@link ReplayRemoveSubjectConcurrencyTest}.
 * */
public class ReplayRemoveSubjectConcurrencyCopiedTest {

    @Test(timeout = 4000)
    public void testReplayRemoveSubjectConcurrentSubscribersDoingReplayDontBlockEachOther() throws InterruptedException {
    ...
    @Test
    public void testReplayRemoveSubjectConcurrentSubscriptions() throws InterruptedException {
        final ReplayRemoveSubject<Long> replay = ReplayRemoveSubject.create();
        Thread source = new Thread(new Runnable() {
    ...
    public void testSubscribeCompletionRaceCondition() {
        for (int i = 0; i < 50; i++) {
            final ReplayRemoveSubject<String> subject = ReplayRemoveSubject.create();
    ...
    static class SubjectObserverThread extends Thread {
        ...
        private final ReplayRemoveSubject<String> subject;
        private final AtomicReference<String> value = new AtomicReference<String>();

        SubjectObserverThread(ReplayRemoveSubject<String> subject) {
    ...
    @Test
    public void testReplayRemoveSubjectEmissionSubscriptionRace() throws Exception {
        ...
        try {
            for (int i = 0; i < 50000; i++) {
                ...
                final ReplayRemoveSubject<Object> rs = ReplayRemoveSubject.create();
